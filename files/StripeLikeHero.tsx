...
// Componente de tarjeta individual con diseño profesional
const FeatureCard = ({ 
  title, 
  icon, 
  gradient,
...
// Componente de línea animada con mejor diseño
const AnimatedLine = ({ 
  x1, 
  y1, 
  x2, 
  ...
  return (
    <>
      ...
      <motion.line
        ...
        x2={x2}
        y2={y2}
        stroke={gradient ? "url(#lineGradient)" : "#a78bfa"}
        strokeWidth="3"
        strokeLinecap="round"
...
// Íconos decorativos de fondo con mejor animación
...
export default function StripeLikeHero() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/30 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[1000px] bg-gradient-radial from-indigo-200/20 to-transparent blur-3xl" />
      ...
      <div className="relative container mx-auto px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100/80 backdrop-blur-sm text-indigo-700 font-medium text-sm border border-indigo-200/50">
            ...
            >
              Réduisez vos coûts, augmentez vos revenus et gagnez en efficacité 
              grâce à une plateforme entièrement intégrée et alimentée par l'IA. 
              Stripe répond à tous vos besoins en matière de paiement.
            </motion.p>
            ...
            >
              <button className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5">
